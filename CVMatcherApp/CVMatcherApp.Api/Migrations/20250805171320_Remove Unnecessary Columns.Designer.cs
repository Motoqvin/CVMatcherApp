...
namespace CVMatcherApp.Api.Migrations
{
    ...
    [Migration("20250805171320_Remove Unnecessary Columns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CVMatcherApp.Api.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CVMatcherApp.Api.Models.CV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CVMatcherApp.Api.Models.User", b =>
                {
            ...
            modelBuilder.Entity("CVMatcherApp.Api.Models.CV", b =>
                {
                    b.HasOne("CVMatcherApp.Api.Models.Result", "AnalysisResult")
                        .WithMany()
                        .HasForeignKey("ResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CVMatcherApp.Api.Models.User", "User")
                        .WithMany("CVs")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CVMatcherApp.Api.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
